...
using System.Web;
using static SmileSCustomerBase.Helper.Authorization;

namespace SmileSCustomerBase.Helper
{
    public class GlobalFunction
    {
        ...
        //    result.UserName = actionContext.Session["Username"].ToString();
        ...
        public static LoginDetail GetLoginDetail(HttpContextBase actionContext)
        {
            ...
            var username = actionContext.Session["Username"].ToString();
        ...
        {
            using (SqlConnection conn = new SqlConnection(new CustomerBaseDBContext().Database.Connection.ConnectionString))
            {
                conn.Open();
