    ...
    public class MenuRoles
    {
        private static List<Menu> GetAllMenu()
        {
            var result = new List<Menu>
            {
                ...
                new Menu(2, 0, 0, " สร้างคิวงาน", "Queue", "QueueCreate", "", "", "Developer,UnderwriteAudit_AdminBusinessPromoteTeam"),
                new Menu(3, 0, 0, " ตรวจสอบผลการคัดกรอง", "Queue", "QueueCheckUnderwriteResult", "", "", "Developer,UnderwriteAudit_BusinessPromoteTeam"),
                new Menu(6, 0, 0, " พิจารณาผลการคัดกรอง", "Queue", "QueueConsideringUnderwriteResult", "", "", "Developer,UnderwriteAudit_Insure"),
                new Menu(4, 0, 0, " รายงาน", "Reports", "ReportCheckUnderwrite", "", "", "Developer,UnderwriteAudit_BusinessPromoteTeam,UnderwriteAudit_Insure"),
                new Menu(5, 0, 0, " จัดการคิวงาน", "Queue", "QueueManageAssign", "", "", "Developer,UnderwriteAudit_AdminBusinessPromoteTeam"),
            };
