using Serilog;
using SmileSCommunicate.App_Start;
using SmileSCommunicate.Controllers;
...
namespace SmileSCommunicate
{
    public class MvcApplication : HttpApplication
    {
        ...
        {
            Log.Error(exception, "[SmileSCommunicate][ExecuteErrorController] - An error occured:{@message}", httpContext.AllErrors);
