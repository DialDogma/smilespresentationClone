...
namespace SmileSDuration.App_Start
{
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            bundles.Add(new StyleBundle("~/Bundles/css")
                ...
                .Include("~/Content/js/plugins/datatable/datatables.css", new CssRewriteUrlTransformAbsolute())
                 .Include("~/Content/js/plugins/datatable/Responsive-2.2.1/css/responsive.dataTables.min.css", new CssRewriteUrlTransformAbsolute())
