...
namespace SmileSPoint.Helper
{
    public class GlobalFunction
    {
        public static string GetAPIUserFromJWTKey(string key)
        {
            ...
            //Get jwt key
            if (Properties.Settings.Default.IsUAT)
            {
                jwtKey = Properties.Settings.Default.JWTKey_UAT;
            }
            else
            {
                jwtKey = Properties.Settings.Default.JWTKey_Production;
            }
        ...
        {
            using (SqlConnection conn = new SqlConnection(new SmilePointEntities().Database.Connection.ConnectionString))
            {
                conn.Open();
