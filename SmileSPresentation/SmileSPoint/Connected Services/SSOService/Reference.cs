...
namespace SmileSPoint.SSOService {
    ...
    public interface ISSOService {
        ...
        SmileSPoint.SSOService.MenuListByRoles[] GetMenuList(string username, string projectName);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISSOService/GetMenuList", ReplyAction="http://tempuri.org/ISSOService/GetMenuListResponse")]
        System.Threading.Tasks.Task<SmileSPoint.SSOService.MenuListByRoles[]> GetMenuListAsync(string username, string projectName);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ISSOServiceChannel : SmileSPoint.SSOService.ISSOService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SSOServiceClient : System.ServiceModel.ClientBase<SmileSPoint.SSOService.ISSOService>, SmileSPoint.SSOService.ISSOService {
        ...
        public SmileSPoint.SSOService.MenuListByRoles[] GetMenuList(string username, string projectName) {
            return base.Channel.GetMenuList(username, projectName);
        }
        
        public System.Threading.Tasks.Task<SmileSPoint.SSOService.MenuListByRoles[]> GetMenuListAsync(string username, string projectName) {
