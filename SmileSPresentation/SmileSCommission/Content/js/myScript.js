...
}, "จำนวนต้องไม่เป็นค่าติดลบ");

window.jQuery.validator.addMethod("checkModelName", (value) => {
    ...
    return true;
}, "ชื่อต้องนำด้วย C_ เท่านั้น ต้องไม่มีอักขระพิเศษ");

window.jQuery.validator.addMethod("checkParameter", (value) => {
    //4-25 letters no special character at least 4 alphabets
    var regex = new RegExp("^(?=(?:.*[a-zA-Z]){4,})[a-zA-z0-9_].{3,50}$");
    ...
    return true;
}, "ต้องมีความยาว4-50 มีตัวอักษร4ตัวขึ้นไป ห้ามมีอักขระพิเศษ");

window.jQuery.validator.addMethod("checkConfig", (value) => {
    //4-25 letters no special character at least 4 alphabets
    var regex = new RegExp("^(?=(?:.*[a-zA-Z]){4,})[a-zA-z0-9_].{3,50}$");
