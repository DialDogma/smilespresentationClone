...
namespace SmileSCommission.Models
{
    ...
    public partial class DatasourceImportedLog
    {
        ...
        public Nullable<int> EditCause_Id { get; set; }
        public string EditRemark { get; set; }
    
        public virtual DatasourceImportedEditCause DatasourceImportedEditCause { get; set; }
        public virtual DatasourceImportedStatus DatasourceImportedStatus { get; set; }
        public virtual DatasourceImportedType DatasourceImportedType { get; set; }
    }
}
