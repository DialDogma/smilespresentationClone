...
namespace UnderwriteCancellation.Helper
{
    public class GlobalFunction
    {
        ...
        public static List<string> GetRoleByUserName(string UserName)
        {
        ...
        {
            using (SqlConnection conn = new SqlConnection(new UnderwriteCancellationEntities().Database.Connection.ConnectionString))
            {
                conn.Open();
