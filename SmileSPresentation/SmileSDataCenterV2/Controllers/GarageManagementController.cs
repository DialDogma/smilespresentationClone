...
namespace SmileSDataCenterV2.Controllers
{
    public class GarageManagementController : Controller
    {
        ...
        public ActionResult GarageManagement()
        {
            ViewBag.OrganizeType = _db.usp_OrganizeType_Select(null, 8, 0, 99999, null, null, null).ToList();
            ViewBag.Province = _db.usp_Province_Select(null).ToList();
            return View();
        }

        [Authorization(Roles = "Developer,DataCenter_Supervisor")]
        public ActionResult GarageDuplicateList(string organizeTypeId, string subDistrictId, string keyword)
        {
        ...
        [Authorization(Roles = "Developer,DataCenter_Supervisor")]
        public ActionResult GarageManageusability()
        {
            ViewBag.OrganizeType = _db.usp_OrganizeType_Select(null, 8, 0, 99999, null, null, null).ToList();
            ViewBag.Province = _db.usp_Province_Select(null).ToList();
            return View();
        ...
        [Authorization(Roles = "Developer,DataCenter_Supervisor")]
        public ActionResult InformationGarageManagement(string organizeID, string mode)
        {
            ...
            ViewBag.ProcessStatus = _db.usp_OrganizeStatus_Select(0, 9999999, null, null, null).ToList();
        ...
        public JsonResult GetGarageOrganizeManagement(int? organizeTypeId = null, int? provinceId = null, string keyword = null, int? draw = null, int? pageSize = null, int? pageStart = null, string sortField = null, string orderType = null, string search = null)
        {
            organizeTypeId = organizeTypeId == -1 ? null : organizeTypeId;
            provinceId = provinceId == -1 ? null : provinceId;
            keyword = keyword == "" ? null : keyword;

            var result = _db.usp_GarageOrganize_Select(null, organizeTypeId, provinceId, keyword, pageStart, pageSize, sortField, orderType, search).ToList();
        ...
        public JsonResult GetGarageOrganizeById(int organizeId)
        {
            var result = _db.usp_GarageOrganize_Select(organizeId, null, null, null, 0, 999, null, null, null).Single();
        ...
        public JsonResult UpdateActiveGarage(int orgainzeId, bool isActive)
        {
            var userID = GlobalFunction.GetLoginDetail(this.HttpContext).User_ID;
        ...
        public JsonResult ContractInsertOrUpdate(int organizeId, bool isContract, string startContractDate = null, string endContractDate = null, int? processStatusId = null, int? claim = null, string remark = null)
        {
            DateTime? d_startContractDate = null;
            DateTime? d_endContractDate = null;

            if (startContractDate != null && startContractDate != "")
            {
                d_startContractDate = Convert.ToDateTime(GlobalFunction.ConvertDatePickerToDate_BE(startContractDate));
            }

            if (endContractDate != null && endContractDate != "")
            {
                d_endContractDate = Convert.ToDateTime(GlobalFunction.ConvertDatePickerToDate_BE(endContractDate));
            }

            remark = remark == "" ? null : remark;
            //claim = claim == null; ? null : claim;

            var userID = GlobalFunction.GetLoginDetail(this.HttpContext).User_ID;
            var rs = _db.usp_OrganizeContractDetail_Insert(organizeId, isContract, null, null, null, null, userID, d_startContractDate, d_endContractDate, processStatusId, claim, remark).Single();
        ...
        public JsonResult InformationInsertOrUpdate(int organizeId, string nearByPlace = null, string organizeContactTel = null, string organizeContactFax = null
                                                    ...
                                                    string marketingContact = null, string marketingTel = null, string marketingEmail = null, string marketingFax = null)
        {
            var userID = GlobalFunction.GetLoginDetail(this.HttpContext).User_ID;
            ...
            var rs = _db.usp_OrganizeInformation_Insert(organizeId, nearByPlace, organizeContactTel, contactType_Tel, organizeContactFax, contactType_Fax, organizeContactEmail, contactType_Email,
                                                        ...
                                                        alternateFinanceFax, accountingContact, accountingTel, accountingEmail, accountingFax, marketingContact, marketingTel, marketingEmail, marketingFax, null, null,
                                                        null, null, userID).Single();
            return Json(rs, JsonRequestBehavior.AllowGet);
        }
        ...
        public async Task<ActionResult> ExportOrganizeReport(int? organizeTypeId = null, int? provinceId = null, string keyword = null)
        {
            ...
            using (var db = new DataCenterV1Entities())
            {
                ...
                var lst = db.usp_GarageOrganize_Select(null, organizeTypeId, provinceId, keyword, 0, 999999999, "Organize_ID", "DESC", null).ToList()
                    .Select(x => new
                    {
                        รหัสรายการ = x.Organize_ID,
                        ประเภท = x.OrganizeTypeDetail,
                        ชื่ออู่ซ่อมรถยนต์ = x.OrganizeDetail,
        ...
        public ActionResult DownloadExportOrganize()
        {
            if (Session["DownloadExcel_Organize"] != null)
            {
                ...
                string excelName = $"Report-GarageOrganize-{DateTime.Now.ToString("yyyyMMddHHmmssfff")}.xlsx";
