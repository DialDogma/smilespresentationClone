...
namespace SmileSHTMLRanking.App_Start
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            bundles.Add(new StyleBundle("~/Bundles/css")
                 ...
                 .Include("~/Content/js/plugins/ckeditor/skins/moono-lisa/editor.css",new CssRewriteUrlTransformAbsolute())
            ...
            bundles.Add(new ScriptBundle("~/Bundles/js")
                ...
                .Include("~/Content/js/plugins/ckeditor/ckeditor.js")
