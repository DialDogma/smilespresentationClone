<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ConvertExcel3.aspx.cs" Inherits="MasterTest.ConvertExcel3" %>
    ...
    <div class="container">
        ...
        <div class="browse">
            <asp:FileUpload ID="UploadFile" runat="server" /><br />
                <asp:Label ID="txtGuide" runat="server" Text="File Format : ktb-sbt.xlsx , ktb-isc.xlsx , ktb-tpa.xlsx and ktb-ssl.xlsx"></asp:Label><br />
        </div>
