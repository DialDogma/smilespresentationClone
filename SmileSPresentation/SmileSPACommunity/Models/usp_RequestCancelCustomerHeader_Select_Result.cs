...
namespace SmileSPACommunity.Models
{
    ...
    public partial class usp_RequestCancelCustomerHeader_Select_Result
    {
        public int RequestCancelCustomerHeaderId { get; set; }
        public string RequestCancelCustomerHeaderCode { get; set; }
