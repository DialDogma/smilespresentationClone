...
namespace SmileSPACommunity.SSOService {
    ...
    public interface ISSOService {
        ...
        SmileSPACommunity.SSOService.MenuListByRoles[] GetMenuList(string username, string projectName);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISSOService/GetMenuList", ReplyAction="http://tempuri.org/ISSOService/GetMenuListResponse")]
        System.Threading.Tasks.Task<SmileSPACommunity.SSOService.MenuListByRoles[]> GetMenuListAsync(string username, string projectName);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ISSOServiceChannel : SmileSPACommunity.SSOService.ISSOService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SSOServiceClient : System.ServiceModel.ClientBase<SmileSPACommunity.SSOService.ISSOService>, SmileSPACommunity.SSOService.ISSOService {
        ...
        public SmileSPACommunity.SSOService.MenuListByRoles[] GetMenuList(string username, string projectName) {
            return base.Channel.GetMenuList(username, projectName);
        }
        
        public System.Threading.Tasks.Task<SmileSPACommunity.SSOService.MenuListByRoles[]> GetMenuListAsync(string username, string projectName) {
