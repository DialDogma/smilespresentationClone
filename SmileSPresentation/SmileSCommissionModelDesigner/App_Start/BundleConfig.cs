...
namespace SmileSCommissionModelDesigner.App_Start
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/Bundles/js")
                ...
                .Include("~/Content/js/plugins/bootstrap-datetimepicker-master/build/js/bootstrap-datetimepicker.min.js")
                .Include("~/Content/js/plugins/bootstrap-datetimepicker-master/build/js/bootstrap-datetimepicker.th.js")
