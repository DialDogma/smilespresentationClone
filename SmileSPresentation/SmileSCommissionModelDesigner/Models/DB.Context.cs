...
namespace SmileSCommissionModelDesigner.Models
{
    ...
    public partial class CommissionCalculateEntities : DbContext
    {
        ...
        public virtual DbSet<CommissionPeriodStatu> CommissionPeriodStatus { get; set; }
        ...
        public virtual DbSet<DatasourceImportedEditCause> DatasourceImportedEditCauses { get; set; }
        public virtual DbSet<DatasourceImportedLog> DatasourceImportedLogs { get; set; }
        public virtual DbSet<DatasourceImportedStatu> DatasourceImportedStatus { get; set; }
        public virtual DbSet<DatasourceImportedType> DatasourceImportedTypes { get; set; }
        public virtual DbSet<DataSourceMaster> DataSourceMasters { get; set; }
        public virtual DbSet<DesignerModel> DesignerModels { get; set; }
        public virtual DbSet<DesignerModelConfig> DesignerModelConfigs { get; set; }
        public virtual DbSet<DesignerModelDatasource> DesignerModelDatasources { get; set; }
        public virtual DbSet<DesignerParameter> DesignerParameters { get; set; }
        public virtual DbSet<Model> Models { get; set; }
        public virtual DbSet<ModelCalculationIndex> ModelCalculationIndexes { get; set; }
        public virtual DbSet<ModelConfig> ModelConfigs { get; set; }
        public virtual DbSet<ModelDatasouce> ModelDatasouces { get; set; }
        public virtual DbSet<ModelParameter> ModelParameters { get; set; }
        public virtual DbSet<ModelParameterDescription> ModelParameterDescriptions { get; set; }
        ...
        public virtual ObjectResult<usp_DesignModel_Datatable_Result> usp_DesignModel_Datatable(string criteria, Nullable<int> pageStart, Nullable<int> pageSize, string sortField, string orderType)
        {
            var criteriaParameter = criteria != null ?
                new ObjectParameter("Criteria", criteria) :
                new ObjectParameter("Criteria", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_DesignModel_Datatable_Result>("usp_DesignModel_Datatable", criteriaParameter, pageStartParameter, pageSizeParameter, sortFieldParameter, orderTypeParameter);
        }
        ...
        public virtual int usp_CloneDataSource(Nullable<int> fromPeriodId, Nullable<int> toPeriodId, string createdBy)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_CloneDataSource", fromPeriodIdParameter, toPeriodIdParameter, createdByParameter);
        }
        ...
        public virtual int usp_ApplyDesignerToCalculationIndex(Nullable<int> designerModelId, Nullable<int> periodId, string createdBy)
        {
            var designerModelIdParameter = designerModelId.HasValue ?
                new ObjectParameter("DesignerModelId", designerModelId) :
                new ObjectParameter("DesignerModelId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_ApplyDesignerToCalculationIndex", designerModelIdParameter, periodIdParameter, createdByParameter);
        }
