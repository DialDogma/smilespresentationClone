...
namespace SmileUnderwriteBranch.SSSDocService {
    ...
    public interface IDocumentService {
        ...
        SmileUnderwriteBranch.SSSDocService.Document[] GetDocument(string refCode, string empCode, int pageSize, int indexStart, string sortField, string orderType);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDocumentService/GetDocument", ReplyAction="http://tempuri.org/IDocumentService/GetDocumentResponse")]
        System.Threading.Tasks.Task<SmileUnderwriteBranch.SSSDocService.Document[]> GetDocumentAsync(string refCode, string empCode, int pageSize, int indexStart, string sortField, string orderType);
        ...
        SmileUnderwriteBranch.SSSDocService.Document[] GetDocumentV2(string refCode);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDocumentService/GetDocumentV2", ReplyAction="http://tempuri.org/IDocumentService/GetDocumentV2Response")]
        System.Threading.Tasks.Task<SmileUnderwriteBranch.SSSDocService.Document[]> GetDocumentV2Async(string refCode);
        ...
        SmileUnderwriteBranch.SSSDocService.Document[] GetDocumentV2SmileDoc(string refCode);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDocumentService/GetDocumentV2SmileDoc", ReplyAction="http://tempuri.org/IDocumentService/GetDocumentV2SmileDocResponse")]
        System.Threading.Tasks.Task<SmileUnderwriteBranch.SSSDocService.Document[]> GetDocumentV2SmileDocAsync(string refCode);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IDocumentServiceChannel : SmileUnderwriteBranch.SSSDocService.IDocumentService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class DocumentServiceClient : System.ServiceModel.ClientBase<SmileUnderwriteBranch.SSSDocService.IDocumentService>, SmileUnderwriteBranch.SSSDocService.IDocumentService {
        ...
        public SmileUnderwriteBranch.SSSDocService.Document[] GetDocument(string refCode, string empCode, int pageSize, int indexStart, string sortField, string orderType) {
            return base.Channel.GetDocument(refCode, empCode, pageSize, indexStart, sortField, orderType);
        }
        
        public System.Threading.Tasks.Task<SmileUnderwriteBranch.SSSDocService.Document[]> GetDocumentAsync(string refCode, string empCode, int pageSize, int indexStart, string sortField, string orderType) {
        ...
        public SmileUnderwriteBranch.SSSDocService.Document[] GetDocumentV2(string refCode) {
            return base.Channel.GetDocumentV2(refCode);
        }
        
        public System.Threading.Tasks.Task<SmileUnderwriteBranch.SSSDocService.Document[]> GetDocumentV2Async(string refCode) {
            return base.Channel.GetDocumentV2Async(refCode);
        }
        
        public SmileUnderwriteBranch.SSSDocService.Document[] GetDocumentV2SmileDoc(string refCode) {
            return base.Channel.GetDocumentV2SmileDoc(refCode);
        }
        
        public System.Threading.Tasks.Task<SmileUnderwriteBranch.SSSDocService.Document[]> GetDocumentV2SmileDocAsync(string refCode) {
