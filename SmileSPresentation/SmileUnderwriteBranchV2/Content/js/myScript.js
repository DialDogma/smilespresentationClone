...
window.chartColors = {
    ...
    brown: 'rgb(150, 75, 0)',
    orange_FF980B: 'rgb(255, 152, 11)',
    yellow_FDFB46: 'rgb(253, 251, 70)',
    green_A3F7A3: 'rgb(163, 247, 163)',
    green_03AC1D: 'rgb(3, 172, 29)',
    red_D10101: 'rgb(209, 1, 1)',
    grey_B9B9B9: 'rgb(185, 185, 185)',
    dark_blue_2836D8: 'rgb(40, 54, 216)',
    sky_blue_5FBFEC: 'rgb(95, 191, 236)',
    red_FF4545: 'rgb(255, 69, 69)',
};
...
//spinnerCancer
const loadingSpinnerCancer = (fadeType, delay = 999999) => {
    switch (fadeType) {
        case "fadeIn":
            $("#loadingCancer").fadeIn(500, (e) => {
                setTimeout(() => {
                    $("#loadingCancer").fadeOut();
                }, delay);
            });
            break;
        case "fadeOut":
            $("#loadingCancer").fadeOut(2000);
            break;
        default:
    }
}
...
const isWindows = () => {
    let check = false;
    if (navigator.userAgent.indexOf("Win") != -1) check = true;
    return check;
}