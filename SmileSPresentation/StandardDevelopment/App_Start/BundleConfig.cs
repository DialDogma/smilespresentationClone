...
namespace StandardDevelopment.App_Start
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            bundles.Add(new StyleBundle("~/Bundles/css")
                ...
                .Include("~/Content/js/plugins/ExcelIntellisenseInput/Excelformulate.css")
            ...
            bundles.Add(new ScriptBundle("~/Bundles/js")
                ...
                .Include("~/Content/js/plugins/Sortable-master/Sortable.min.js")
                ...
                .Include("~/Content/js/plugins/ExcelIntellisenseInput/Excelformulate.js")
