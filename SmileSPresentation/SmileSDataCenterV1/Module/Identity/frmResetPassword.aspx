<%@ Page Title="" Language="C#" MasterPageFile="~/Master1.Master" AutoEventWireup="true" CodeBehind="frmResetPassword.aspx.cs" Inherits="SmileSDataCenterV1.Module.Identity.frmResetPassword" Theme="default" %>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-10  col-md-offset-1 ">
                                    ...
                                    <asp:PlaceHolder runat="server" ID="plhResetPasswordform" Visible="false">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <span class="input-group-addon">
                                        ...
                                        <div class="form-group">
                                            <asp:Button runat="server" ID="btnResetPassword" Text="ยืนยัน" SkinID="success" OnClick="btnResetPassword_click" />
                                        </div>
                                    </asp:PlaceHolder>
                                </div>
                            </div>
