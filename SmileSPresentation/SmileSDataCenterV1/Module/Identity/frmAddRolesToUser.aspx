<%@ Page Title="" Language="C#" MasterPageFile="~/Master1.Master" AutoEventWireup="true" CodeBehind="frmAddRolesToUser.aspx.cs" Inherits="SmileSDataCenterV1.Module.Identity.frmAddRolesToUser" Theme="default" %>
                            ...
                            <div class="row">
                                <div class="center-block">
                                    <img class="profile-img"
                                        src="https://cdn1.iconfinder.com/data/icons/unique-round-blue/93/group-128.png" alt="" />
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-10  col-md-offset-1 ">
                                    ...
                                    <asp:PlaceHolder runat="server" ID="plhRoleSelect" Visible="false">
                                        <div class="form-group">
                                            ...
                                            <asp:Button runat="server" ID="btnAddRolesToUser" Text="เพิ่ม Roles" CssClass="btn btn-success btn-block" OnClick="btnAddUserToRoles_Click" />
                                        </div>
                                    </asp:PlaceHolder>
                                </div>
                            </div>
