<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmReportClaimVoucher.aspx.cs" Inherits="ReportClaim.frmReportClaim" %>
            ...
            <table style="width: 100%; margin-left: 40px">
                <tr>
                    ...
                    <td style="width: 12.5%" rowspan="5">
                        <span><img src="../../../Image/logoSiamSmile.jpg" /></span>
                    </td>
                    <td style="width: 12.5%"></td>
                </tr>
                <tr>
                    ...
                    <td style="width: 12.5%; text-align: left" colspan="2">
                        <asp:Label runat="server" ID="lblHospitalName" Font-Size="Small"></asp:Label>
                    </td>
                    <td style="width: 12.5%"></td>
                    <td style="width: 12.5%"></td>
                    <td style="width: 12.5%"></td>
                ...
                <tr>
                    <td style="width: 12.5%; margin-left: 50px" colspan="4">
                        <a>เรื่อง ขอรับรองการพิจารณาสินไหมการรักษาพยาบาลของ</a>
                        &nbsp&nbsp&nbsp
                        <asp:Label runat="server" ID="lblCustomerName" Font-Size="Small"></asp:Label>
                    </td>
                ...
                <tr>
                    <td style="width: 25%; margin-left: 50px">
                        Application ID :<asp:Label runat="server" ID="lblAppID" Font-Size="Small"></asp:Label>
                    </td>
                    <td style="width: 25%" >
                        ID Card : <asp:Label runat="server" ID="lblIDCard" Font-Size="Small"></asp:Label>
                    </td>
                    <td style="width: 12.5%" > </td>
                    <td style="width: 12.5%"></td>
                    <td style="width: 12.5%"></td>
            ...
            <table style="width: 90%; border-spacing: 0; margin-left: 35px">
                ...
                <tr>
                    ...
                    <td style="width: 55%; border: solid 1px black; border-right-style: hidden; border-top-style: hidden; border-left-style: hidden" colspan="1">
                        <asp:Label runat="server" ID="lblTotalFirst" Text=""></asp:Label>
                    </td>
                ...
                <tr>
                    ...
                    <td style="width: 55%; border: solid 1px black; border-right-style: hidden; border-top-style: hidden; border-left-style: hidden" colspan="1">
                        <asp:Label runat="server" ID="lblTotalSecond" Text=""></asp:Label>
                    </td>
                    <td style="width: 15%; text-align: right; padding: 5px; border: solid 1px black; border-top-style: hidden; border-right-style: hidden">
                ...
                <tr>
                    <td style="width: 5%; border: solid 1px black; border-right-style: hidden; border-top-style: hidden"></td>
                    <td style="width: 55%; border: solid 1px black; border-right-style: hidden; border-top-style: hidden; border-left-style: hidden" colspan="1">
                        <asp:Label runat="server" ID="lblTotalThird" Text=""></asp:Label>
                    </td>
                    <td style="width: 15%; text-align: right; padding: 5px; border: solid 1px black; border-top-style: hidden; border-right-style: hidden">
            ...
            <table style="width: 90%; margin-left: 35px">
                <tr>
                    <td style="width: 12.5%; font-size: x-small; color: #808080">
                        <asp:Label runat="server" ID="lblComment" Font-Size="Small"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
