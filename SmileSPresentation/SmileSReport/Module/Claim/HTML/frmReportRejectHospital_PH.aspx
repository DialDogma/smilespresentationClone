<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmReportRejectHospital_PH.aspx.cs" Inherits="SmileSReport.Module.Claim.HTML.frmReportHospitalReject_PH" %>
        ...
        <div class="page">
            ...
            <div class="content">
                <table width="100%" border="0" style="border-collapse: collapse">
                    ...
                    <tr>
                        <td class="tr-nomal">&nbsp;</td>
                        <td class="tr-nomal" style="font-weight: 500">อ้างถึง</td>
                        <td colspan="6" class="tr-nomal">invoice เลขที่<asp:Label runat="server" ID="lblInvoiceNo"></asp:Label></td>
                    </tr>
                    <%--row 6--%>
                    <tr>
                        <td colspan="8" class="tr-nomal">&nbsp;</td>
