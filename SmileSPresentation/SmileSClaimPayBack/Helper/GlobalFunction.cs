...
namespace SmileSClaimPayBack.Helper
{
    public class GlobalFunction
    {
        ...
        {
            using (SqlConnection conn = new SqlConnection(new ClaimPayBackEntities().Database.Connection.ConnectionString))
            {
                conn.Open();
        ...
        public static string GetEnvironment(HttpContextBase actionContext)
        {
            return Properties.Settings.Default.Environment;
        }
