...
namespace SmileClaimV2.Helper
{
    public class GlobalFunction
    {
        ...
        public static LoginDetail GetLoginDetail(HttpContextBase actionContext)
        {
            ...
            //-------------------------Last Code 2025-04-29 --------------------//
            //var auth = OAuth2Helper.GetLoginDetail();
        ...
        {
            using (SqlConnection conn = new SqlConnection(new HospitalClaimInformV1Entities().Database.Connection.ConnectionString))
            {
                conn.Open();
