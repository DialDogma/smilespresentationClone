...
namespace SmileMotorV1.Models
{
    ...
    {
        public static void ExportToExcel<T>(HttpContext actionContext, List<T> lst, string SheetName, string FileName)
        {
        ...
        public static void ExportToExcel<T>(HttpContext actionContext, List<T> lst, string SheetName, string FileName, List<T> lst2, string SheetName2)
        {
            //Convert List To Datatable
            var dt = ToDataTable(lst);
            var dt2 = ToDataTable(lst2);
        ...
        public static void LoadGridview(GridView gv, DataTable dt, string dk = null)
        {
            gv.DataSource = dt;

            if (dk != null)
            {
                gv.DataKeyNames = new string[] { dk };
            }

            gv.DataBind();
        }

        public static void LoadGridviewByList<T>(GridView gv, IList<T> lst, string dk = null)
        {
            gv.DataSource = lst;
