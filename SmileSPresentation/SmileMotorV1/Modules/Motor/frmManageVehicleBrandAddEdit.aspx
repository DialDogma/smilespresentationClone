<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmManageVehicleBrandAddEdit.aspx.cs" Inherits="SmileMotorV1.Modules.Motor.ucManageVehicleBrandAddEdit" %>
                ...
                <div class="panel-body">
                    <table style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td style="width: 12.5%">
                                <asp:TextBox ID="txtBrand" runat="server" CssClass="form-control input-sm" Width="100%" placeholder="ยี่ห้อ"></asp:TextBox>
                            </td>
                            <td style="width: 12.5%"></td>
                            <td style="width: 12.5%"></td>
                            <td style="width: 12.5%"></td>
