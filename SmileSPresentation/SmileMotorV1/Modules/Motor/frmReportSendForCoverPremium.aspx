<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmReportSendForCoverPremium.aspx.cs" Inherits="SmileMotorV1.Modules.Motor.frmReportSendForCoverPremium" Theme="default" %>
    ...
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4>รายงานเบี้ยประกันนำส่งขอความคุ้มครอง</h4>
            </div>
                        ...
                        <td style="width: 100%;" colspan="6">
                            <asp:GridView ID="dgvMain" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="SendForCoverHeader_Code" HeaderText="เลขที่นำส่ง" />
                                    <asp:BoundField DataField="MotorApplicationContractTypeDetail" HeaderText="ประเภทสัญญา" />
                                    <asp:BoundField DataField="SendForCoverDetail_Code" HeaderText="เลขที่อ้างอิง" />
                                    <asp:BoundField DataField="MotorApplication_Code" HeaderText="เลขแอพพลิเคชั่น" />
                                    <asp:BoundField DataField="CustomerFullName" HeaderText="ผู้เอาประกันภัย" />
                                    <asp:BoundField DataField="BankDetail" HeaderText="ธนาคาร" />
                                    <asp:BoundField DataField="BankAccountNo" HeaderText="เลขที่บัญชี" />
                                    <asp:BoundField DataField="TransactionDateTime" HeaderText="วันที่รับเบี้ย" DataFormatString="{0:dd/MM/yyyy hh:mm}" />
                                    <asp:BoundField DataField="TransferPremiumAmount" DataFormatString="{0:###,###.00}" HeaderText="ยอดเงิน" ItemStyle-HorizontalAlign="Right" />
