...
namespace SmileSCriticalIllness.App_Start
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            bundles.Add(new StyleBundle("~/Bundles/css")
                 ...
                 .Include("~/Content/css/prettify.css")
                 .Include("~/Content/css/answerListStyle.css")
            ...
            bundles.Add(new ScriptBundle("~/Bundles/js")
                ...
                .Include("~/Content/js/plugins/twitter-bootstrap-wizard-master/prettify.js")
                .Include("~/Content/js/plugins/twitter-bootstrap-wizard-master/jquery.bootstrap.wizard.min.js")
